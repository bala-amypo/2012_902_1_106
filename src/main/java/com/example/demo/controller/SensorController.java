...
public class SensorController {
    ...
    @Operation(summary = "Create sensor", description = "Create a new sensor at a location")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get sensor by ID", description = "Retrieve a specific sensor by ID")
